...
Mittels `new Promise()` können wir ein komplett eigenes Promise erstellen. Ein
typsiches Demo-Beispiel ist ein Timeout-Promise, welches einige Sekunden warten:
...
```html
<script type="module" src="https://app.unpkg.com/lodash-es@4.17.21/files/throttle.js"></script>
```
