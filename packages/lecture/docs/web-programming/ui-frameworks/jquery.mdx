...
> jQuery is used by 69.4% of all the websites [that we monitor]
...
> WordPress is used by 42.2% of all the websites [that we monitor]
...
Ein weiterer interessanter Datenpunkt ist das [2025 Developer Survey](https://survey.stackoverflow.co/2025/technology)
...
nächsten Jahr arbeiten werden. Hier ist [React auf Platz 2 mit knapp 45% und
jQuery auf Platz 3 mit 23%.](https://survey.stackoverflow.co/2025/technology#1-web-frameworks-and-technologies)
...
der ganzen Welt teilnehmen. [Bezüglich jQuery finden](https://2025.stateofjs.com/en-US/other-tools/#libraries)
wir hier, dass nur 16% der Teilnehmer jQuery regelmäßig verwendet. Bei Front-end frameworks,
die wir uns noch anschauen, [wurde etwa](https://2025.stateofjs.com/en-US/libraries/front-end-frameworks/#front_end_frameworks_ratios)
React von 85% der Teilnehmer schon genutzt, Vue.js von 52%, Svelte von 27%. 
