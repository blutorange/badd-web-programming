...
gelöscht, alle gelöscht) oder ein TODO erledigt wird, mustten wir manuell
...
es die Probleme der direkten DOM-Manipualtion löst. Um es nochmal zusammenzufassen,
