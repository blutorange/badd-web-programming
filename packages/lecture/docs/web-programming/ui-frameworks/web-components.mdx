...
- constructor &mdash; Wenn eine neue Instanz des Elements erstellt werden soll,
  also z.B. jedesmal, wenn das Element im HTML verwendet wird. Hier können
...
Der Shadow-DOM kappselt den Inhalt unseres Custom Element von der darumliegenden
...
Webseite beispielsweise die Schriftgröße auf 20 und die Schriftarbe auf Rot, dann
hat auch der Inhalt unseres Custom Element diese Schriftgröße und Schriftarbe, sofern
...
<p>
  <Link to="/sandbox?snippet=custom-components-emoji-picker&tab=js" target="_blank" rel="noopener noreferrer">Playground &mdash; Emoji-Picker</Link>
</p>
...
auf Änderungen der Attribute reagieren. Aber wenn wir etwa intern ein Datemodell
...
die Erstellung von Web Components zu vereinfachen.

Im autonomous custom element  und  customized built-in element. features builtin elements, noch nicht perfekt
...
Nachteile: - low level
Vorteile: standard, tools wie svelte erlauben export nach custom elements

frameworks fuer komponenten wie stencil