...
Wie im Beispiel oben zu sehen, wird das oft verwendet, um Webseiten responsiv
zu gestalten, sodass diese auff allen Geräten bedienbar sind.
...
wir haben eine Tabellenkomponente entwickelt, die andere in ihre Webesite einbinden
...
gerne abhängig davon, wieviel Platz unserer Tabelle zur Verfügung steht, das
...
:::info
Bei vertikalen Schreibsrichtung reagiert `container: inline-size` nur auf die
