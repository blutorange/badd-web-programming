...
- https://owasp.org/www-community/attacks/
  - Liste bekannter Angriffszenarien
...
Damit der Nutzer sich nicht jedesmal neu anmelden muss, können wir einen
...
Lieferaddresse. Das funktioniert, weil der Browser automatisch das Session-Cookie mitsendet.
...
Um dieses Angriffszenario zu verhindern, könnten wir etwa `<script>`-Elemente
