...
Das ist, was [Web Sockets](https://developer.mozilla.org/en-US/docs/Web/API/WebSocket)
uns ermöglichen.

## Bidirektionale Kommunikation

Mit einem [Web Socket](https://developer.mozilla.org/en-US/docs/Web/API/WebSocket) ist eine
bidirektionale Kommunikation zwischen Server und Client möglich. Das bedeutet, wir können
dem Server Nachrichten senden (wann wir wollen); und der Server kann uns Nachrichten senden
(wann er will).
