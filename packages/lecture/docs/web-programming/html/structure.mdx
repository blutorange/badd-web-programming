...
<university id="dhdd" name="Duale Hochschule Dresden">
  <courses>
    <course id="mi" name="Medientinformatik">
...
eine Rolle spielen. Damit können wir Elemente klassifzieren, wie im unteren
...
also keine Rolle, wieviele Leerzeichen wir verwenden, der Nutzer sieht immer
...
Der technische Name hierfür ist [Tag Omisssion](https://html.spec.whatwg.org/multipage/syntax.html#syntax-tag-omission).
...
innerhalb des Shadow-DOM beeinflussen nicht die darumliegende Webseite.
