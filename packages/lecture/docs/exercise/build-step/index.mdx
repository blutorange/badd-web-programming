...
binden Sie dort das Script aus `dist/src/index.js` ein! Öffnen sie die HTML-Seite
...
ergänzen Sie das Script `build.js` um zusätzliche Logik, welche alle HTML-Dateien
...
Ergänzen Sie nun das Script `build.js` so, dass analog zum JavaScript eine
...
## Aufgabe 14 - TypeScript (optional)
