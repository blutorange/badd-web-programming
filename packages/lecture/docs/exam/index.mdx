...
__Nach Absprache__ kann auch eine ganz eigene Aufgabenstellung erdacht und bearbeitet
werden. Dies richtet sich besonders an Personen, die bereits Erfahrung im Bereich
Webentwicklung haben und eine anspruchsvolle Aufgabe suchen.
...
:::info
Es darf __JavaScript__, __TypeScript__, [Flow](https://flow.org/) oder jede andere Sprache verwendet werden,
die zu JavaScript oder WebAssembly transpiliert und damit nativ im Browser
ausführbar ist (z.B. [CoffeeScript](https://coffeescript.org/), [Elm](https://elm-lang.org/), [Dart](https://dart.dev/web/wasm)).

Es darf jedes UI-Framework verwendet werden, das ist aber keine Pflicht. Alle
Aufgaben sind auch mit nativen Funktionen lösbar.
:::
...
Linter sind beispielsweise etwa [Biome](https://biomejs.dev/guides/getting-started/) oder [eslint](https://eslint.org/).

Code-Formatierer sind beispielsweise etwa [Biome](https://biomejs.dev/guides/getting-started/) oder [Prettier](https://prettier.io/).

Bundler um den Code mit Abhängigkeiten zu einer Datei zusammenzufügen sind beispielsweise etwa [esbuild](https://esbuild.github.io/),
...
Alternativ kann auch ein "modernes" Seitenlayout mit einer ausklappbaren Sidebar (Menubar) erstellt werden.

![Seitenlayout mit Header, Main-Content, Footer und Sidebar](/img/exam/page-frame-2.png)

#### Seitenlayout

* Es sollen die entsprechenden semantischen HTML-Elemente verwendet werden (`<header>`, `<nav>`, `<main>`, `<aside>`, `<footer>`)
* Im Header bzw. der Sodebar ist eine Navigationsleiste unterzubringen. Hier sollen Links auf die
...
* Der Inhalt der rechten Sidebar kann mit beliebigen Inhalt gefüllt werden.
...
* Bildergallerie
  * Eine Seite mit 10 oder mehr beliebigen Bildern, welche von links nach rechts und
  von oben nach unten angeordnet sind. Für jedes Bild soll das
...
Es dürfen beliebige UI-Frameworks und beliebige Bibliotheken verwendet werden.
